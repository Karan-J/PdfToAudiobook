...
def read():
    ...
    start = 1           #had to hardcode this variables since there were issues with my code-setup
    end = 4             #had to hardcode this variables since there were issues with my code-setup
...
def write_text(filename, text):
    writer = PdfFileWriter() #Creating a PDF writer object
